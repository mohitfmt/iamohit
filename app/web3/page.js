...
const Web3Hero = dynamic(() => import("@/components/Heros/Web3Hero"), {
  loading: () => (
...
export const metadata = {
  keywords: [
    ...
    "Contact for Innovations",
  ],
  title:
    "Navigating the Future with Web 3.0 & Blockchain Expertise | iAMohit Portfolio",
  description:
    "Dive into the cutting-edge realm of Web 3.0 and Blockchain with a seasoned technologist. Explore captivating 3D web applications, smart contracts, and the Ethereum ecosystem. Unleash innovation with iAMohit's expertise.",
};
