...
export const metadata = {
  ...
  title:
    "About Mohit Shrivastava | Full Stack Developer & Digital Transformation Specialist",
  description:
    "Discover the journey of Mohit Shrivastava, an innovative Full Stack Developer and Digital Transformation Specialist with over 17 years of experience. Unveil the evolution from coding enthusiast to tech leader.",
};
